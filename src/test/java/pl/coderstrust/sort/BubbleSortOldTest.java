...
public class BubbleSortOldTest {

    @Test
    @Parameters(method = "inputData")
    public void bubbleSortVerification(int[] expectedArray, int[] notSortedArray) {
        BubbleSort bubbleSort = new BubbleSort();
        assertArrayEquals(expectedArray, bubbleSort.sort(notSortedArray));
    }
