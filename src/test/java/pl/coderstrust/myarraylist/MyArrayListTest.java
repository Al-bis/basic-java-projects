...
public class MyArrayListTest {
  ...
  @Test
  public void shouldThrownExceptionWhenGivenElementIsNull() {
  ...
  public void shouldSetElementBaseOnGivenIndex(Long givenElement) {
    ...
    myArrayList.add(4L);
    myArrayList.add(5L);
    Long previousElement = myArrayList.set(2, givenElement);
    Long element = myArrayList.get(2);

    assertEquals(givenElement, element);
    assertEquals((Long) 3L, previousElement);
  }
  ...
  public void shouldRemovedElementBaseOnGivenIndex() {
    ...
    myArrayList.add(4L);
    myArrayList.add(5L);
    Long previousElement = myArrayList.remove(2);
  ...
  public void shouldRemovedElementBaseOnGivenObject() {
    ...
    boolean isStillOnList = myArrayList.contains(object);

    assertEquals(4, myArrayList.size());
    assertEquals((Long) 4L, myArrayList.get(2));
    assertFalse(isStillOnList);
  }
